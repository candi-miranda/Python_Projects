...
# CASO QUADRÁTICO: 3 pontos de controlo (Raiz, Meio, Ponta)
points_chord = 3
...
recorder = om.SqliteRecorder("aero_quadratic.db")
prob.driver.add_recorder(recorder)
prob.driver.recording_options['record_derivatives'] = True
prob.driver.recording_options['includes'] = ['*']

# VARIÁVEIS DE DESIGN: Alpha + Corda Paramétrica (Quadrática)
