...
prob.model.add_design_var("tail_span", lower=7.0, upper=10.0, units="m", scaler=0.1)
prob.model.add_design_var("wing_sweep", lower=0.0, upper=10.0, units="deg", scaler=0.1)
