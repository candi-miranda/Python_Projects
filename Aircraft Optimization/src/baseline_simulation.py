...
for iy in range(mesh_wing.shape[1]):
    ...
    xq = 0.25 * 3.11 + mesh_wing[0, iy, 1] * np.sin(np.radians(3.0))
    for ix in range(5): mesh_wing[ix, iy, 0] = (xq - 0.25 * c_loc) + float(ix) / 4.0 * c_loc
...
surf_wing = {
    ...
    "span": 27.05, "data_x_upper": w_xu, "data_x_lower": w_xl, "data_y_upper": w_yu, "data_y_lower": w_yl,
...
surf_tail = {
    ...
    "span": 8.49, "data_x_upper": t_xu, "data_x_lower": t_xl, "data_y_upper": t_yu, "data_y_lower": t_yl,
...
prob.setup()
prob.model.AS_point_0.coupled.linear_solver = om.DirectSolver()
prob.model.AS_point_1.coupled.linear_solver = om.DirectSolver()

prob.model.AS_point_0.coupled.nonlinear_solver.options['atol'] = 1e-5
prob.model.AS_point_0.coupled.nonlinear_solver.options['rtol'] = 1e-5
prob.model.AS_point_1.coupled.nonlinear_solver.options['atol'] = 1e-5
prob.model.AS_point_1.coupled.nonlinear_solver.options['rtol'] = 1e-5
...
print(
    ...
    prob.get_val("wing.structural_mass")[0] / surf_wing["wing_weight_ratio"],
    "[kg]",
)
...
print("twist_cp =", prob.get_val("wing.twist_cp"))
print("tail twist_cp =", prob.get_val("tail.twist_cp"))
print("spar thickness =", prob.get_val("wing.spar_thickness_cp"))
print("skin thickness =", prob.get_val("wing.skin_thickness_cp"))
print("C_D =", prob.get_val("AS_point_0.wing_perf.CD"))
print("C_L =", prob.get_val("AS_point_0.wing_perf.CL"))
print("tail C_D =", prob.get_val("AS_point_0.tail_perf.CD"))
...
print("AS_point_0.L_equals_W =", prob.get_val("AS_point_0.L_equals_W"))
print("AS_point_1.L_equals_W =", prob.get_val("AS_point_1.L_equals_W"))
print("AS_point_1.wing_perf.failure =", prob.get_val("AS_point_1.wing_perf.failure"))
print("AS_point_1.tail_perf.failure =", prob.get_val("AS_point_1.tail_perf.failure"))
print("chord =", prob.get_val("AS_point_0.coupled.wing.lengths"))
print("tail chord =", prob.get_val("AS_point_0.coupled.tail.lengths"))